...
public static class BattleAutoTestRunner
{
    ...
    public static void RunBattleLogicAutoTest()
    {
        ...
        SetPrivateField(battleUI, "captureRehearsalText", CreateText("Capture Rehearsal Text"));
        ...
        AppendCheck(ref passed, ref report, "Run status starts compact active", battleManager.DebugRunStatusText == "Run: Active");
        AppendCheck(ref passed, ref report, "Battle starts with a compact first encounter objective", battleManager.DebugStageObjectiveText == "Goal: Defeat Slime Scout");
        AppendCheck(ref passed, ref report, "Battle starts with compact encounter progress", battleManager.DebugStageProgressText == "Enc 1/2 | Active");
        ...
        AppendCheck(ref passed, ref report, "Compact skill help explains all commands, Guard, and readable enemy pattern values", battleManager.DebugSkillHelpText.Contains("Slash:") && battleManager.DebugSkillHelpText.Contains("Fire Bolt:") && battleManager.DebugSkillHelpText.Contains("Ice Lance:") && battleManager.DebugSkillHelpText.Contains("Lightning Strike:") && battleManager.DebugSkillHelpText.Contains("Guard -50% damage") && battleManager.DebugSkillHelpText.Contains("Normal attack:") && battleManager.DebugSkillHelpText.Contains("Heavy Slam:"));
        ...
        AppendCheck(ref passed, ref report, "Fire impact profile is GIF-ready with cast flare, burst, and ring feedback", SkillProjectile.DebugImpactProfile(ElementType.Fire).Contains("Cast=50") && SkillProjectile.DebugImpactProfile(ElementType.Fire).Contains("Sparks=8") && SkillProjectile.DebugImpactProfile(ElementType.Fire).Contains("Ring=72") && SkillProjectile.DebugImpactProfile(ElementType.Fire).Contains("Shake=0.11"));
        AppendCheck(ref passed, ref report, "Lightning impact profile has the strongest cast flare, shake, and large hit ring", SkillProjectile.DebugImpactProfile(ElementType.Lightning).Contains("Cast=58") && SkillProjectile.DebugImpactProfile(ElementType.Lightning).Contains("Sparks=7") && SkillProjectile.DebugImpactProfile(ElementType.Lightning).Contains("Ring=86") && SkillProjectile.DebugImpactProfile(ElementType.Lightning).Contains("Shake=0.14"));
        AppendCheck(ref passed, ref report, "Ice impact profile keeps readable slower feedback with a smaller cast flare", SkillProjectile.DebugImpactProfile(ElementType.Ice).Contains("Cast=42") && SkillProjectile.DebugImpactProfile(ElementType.Ice).Contains("Sparks=5") && SkillProjectile.DebugImpactProfile(ElementType.Ice).Contains("Ring=54") && SkillProjectile.DebugImpactProfile(ElementType.Ice).Contains("Shake=0.07"));
        ...
        AppendCheck(ref passed, ref report, "Stage objective names the next encounter before Continue", battleManager.DebugStageObjectiveText.Contains("Clear: Stage 1-1: Slime Scout") && battleManager.DebugStageObjectiveText.Contains("-> Stage 1-2: Slime King"));
        ...
        AppendCheck(ref passed, ref report, "Run status guides the player to continue after encounter clear", battleManager.DebugRunStatusText == "Run: Clear -> Next");
        ...
        AppendCheck(ref passed, ref report, "Run status marks final Stage 1 clear after final clear", battleManager.DebugRunStatusText == "Run: Stage Clear");
        ...
        AppendCheck(ref passed, ref report, "Stage objective marks Stage 1 clear after final boss victory", battleManager.DebugStageObjectiveText == "Clear: Stage 1");
        AppendCheck(ref passed, ref report, "Stage progress marks final stage clear", battleManager.DebugStageProgressText == "Enc 2/2 | Clear");

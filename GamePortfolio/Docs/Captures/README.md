...
Unity screenshots and contact sheet for the portfolio README. Batch 77 captures are generated by the standalone `CaptureRunner.exe` and written directly to this folder via `-captureOutputDir`, then checked for non-black frames and contact-sheet readability.

...
| 6 | Reach Victory or Defeat | Result panel appears with `Damage dealt`, `Damage taken`, `Guard uses`, `Skills used`, `Rank`, `Reward`, `Tip`, and last enemy pattern |
...
4. `04_result_summary_rank.png` - result summary with panel, damage, Guard uses, Skills used, Rank, Reward, and Tip
